...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    //采购到货单
    var fhdurl = gatewayurl + "/yonbip/scm/arrivalorder/list?access_token=" + request.access_token;
    console.log("到货单列表查询接口URL->" + fhdurl);
    ...
    if ("200" == responseObj.code) {
      ...
      var colArry =
        ...
        "arrivalOrders_producedate,define2,define3,arrivalOrders_warehouse,arrivalOrders_invaliddate,memo,arrivalOrders_taxitems_code";
