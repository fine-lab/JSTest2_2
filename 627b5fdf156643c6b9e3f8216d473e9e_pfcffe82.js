...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let productUrl = `https://api.diwork.com/yonbip/digitalModel/product/detail?access_token=${access_token}&id=${productId}&productApplyRangeId=${productApplyRangeId}`;
    productRes = postman("get", productUrl, null, null);
