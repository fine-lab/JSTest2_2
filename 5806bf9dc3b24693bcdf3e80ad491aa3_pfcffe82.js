...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let orgId = "yourIdHere"; //二厂
    let productId = "yourIdHere"; //直译003
    let productUrl = `https://api.diwork.com/yonbip/digitalModel//product/detail?access_token=${access_token}&id=${productId}&productApplyRangeId=${orgId}`;
    var productRes = postman("get", productUrl, null, null);
    let taxrateUrl = `https://api.diwork.com/yonbip/digitalModel/taxrate/findById?access_token=${access_token}&id=${outTaxrate}`;
    var taxrateInfo = postman("get", taxrateUrl, null, null);
    return {};
  }
}
