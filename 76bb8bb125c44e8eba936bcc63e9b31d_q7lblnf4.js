...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    var sql = "select hanshuijine,mingxi,jine,shuie from GT68626AT5.GT68626AT5.fapiaozibiao where fapiao_id = '" + jsonStringList[0].id + "'";
    ...
    for (var i = 0; i < res1.length; i++) {
      ...
      let apiResponse1 = openLinker("get", base_path1, "GT68626AT5", JSON.stringify({}));
    ...
    let apiResponseFu = openLinker("post", base_path, "GT68626AT5", JSON.stringify(bodyFu));
    return { apiResponse };
