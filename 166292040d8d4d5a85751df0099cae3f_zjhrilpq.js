...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    busAllData();
    var res = ObjectStore.insertBatch("GT1281AT3.GT1281AT3.reqbuy1", buyData, "641c902f");
    var s = res;
    function busAllData() {
      buyarray.forEach((data) => {
        var listbuyMap = {};
        listbuyMap["ysbuycode"] = data.code;
        listbuyMap["ysbuyid"] = data.id;
        listbuyMap["iscreathmdordr"] = "2";
        listbuyMap["goodid"] = data.applyorders_product_cCode;
        listbuyMap["buycount"] = data.applyorders_qty;
