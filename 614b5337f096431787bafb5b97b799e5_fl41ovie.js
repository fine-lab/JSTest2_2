...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    var code = data.code;
    var xiangmumingchena = data.xiangmumingchena;
    var zhidanrenzuzhi = data.zhidanrenzuzhi;
    var billid = data.id;
    var xiangmudanganzhujian = data.xiangmudanganzhujian;
    var body;
    if (xiangmudanganzhujian !== undefined) {
      body = {
        data: {
          id: xiangmudanganzhujian,
          orgid: zhidanrenzuzhi,
          code: code,
          name: {
            zh_CN: xiangmumingchena
          },
          enable: "1",
          sysid: "1",
          _status: "Update"
    ...
    var token = getToken("75690fe167304191be9b57c9a2f158e1", "0767d0cba0414920947c771f4212c0a8");
    ...
    if (queryCode !== "200") {
      throw new Error("新增项目错误 " + apiResponsejaon.message);
    } else {
      var xiaoshouhetongid = apiResponsejaon.data.id;
      var object = { id: billid, xiangmudanganzhujian: xiaoshouhetongid, xiangmudanganzhujian_name: xiangmumingchena };
      var retobj = ObjectStore.updateById("GT70729AT8.GT70729AT8.LXSQ", object);
    }
