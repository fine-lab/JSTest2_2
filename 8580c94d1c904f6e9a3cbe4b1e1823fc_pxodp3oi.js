viewModel.on("customInit", function (data) {
  // 通用报销单--页面初始化
  var girdModel = viewModel.getGridModel("expapportions"); //费用分摊
  viewModel.getGridModel("expapportions").getEditRowModel().get("pk_project_name").setState("bMustSelect", true);
  girdModel
    .getEditRowModel()
    .get("expapportionuserdefs!define3_name")
  ...
  var girdModel1 = viewModel.getGridModel("expensebillbs");
  return;
  girdModel
    .getEditRowModel()
