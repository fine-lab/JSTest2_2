...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    // 获取员工详细信息
    let func3 = extrequire("GT6948AT29.staff.showStaffInfoByIdCd");
    request.id = staffId;
    ...
    if (mainJobList === undefined || mainJobList === null || mainJobList.length === 0) {
      throw new Error("当前用户没有主职信息");
    } else {
