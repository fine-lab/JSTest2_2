...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    if ("200" == responseObj.code) {
      ...
      var recordList = [];
      var colArry =
        "vouchdate,code,busType,vendor,vendor_name,arrivalOrders_id,id,invoiceSupplier,currency,auditTime,natCurrency,product," +
        "product_cCode,propertiesValue,unit,qty,arrivalOrders_purUOM,taxRate,arrivalOrders_invExchRate,arrivalOrders_isExpiryDateManage," +
