...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    var resultcustsql = ObjectStore.queryByYonQL("select rebateDefineCharacter.attrext15 as define1 FROM voucher.rebate.AmountRebate where rebateId='" + data.headItem.rebateId + "'", "marketingbill");
    let body = {
      data: [
        {
