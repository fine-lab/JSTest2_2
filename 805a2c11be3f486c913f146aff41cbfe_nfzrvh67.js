...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var PurDATES = PurDATEES(access_token, request.supplierid, request.project);
    //获取采购接口方法
    function PurDATEES(access_token, supplierid, project) {
      //设置返回的access_token
      // 获取token的url
      ...
      const Body = {
        ...
        fields: [
          ...
          {
            name: "currency",
            alias: "currency_NONE_",
            aggr: ""
          },
          {
            name: "billno",
            alias: "billno_DISCOUNT_",
            aggr: "count_distinct"
          },
          {
            name: "accountdate",
            alias: "accountdate_DISCOUNT_",
            aggr: "count_distinct"
          },
          {
            name: "description",
            alias: "description_DISCOUNT_",
            aggr: "count_distinct"
          },
          {
            name: "de_amount",
            alias: "de_amount_SUM_",
            aggr: "sum"
          },
          {
            name: "de_local_amount",
            alias: "de_local_amount_SUM_",
            aggr: "sum"
          },
          {
            name: "cr_amount",
            alias: "cr_amount_SUM_",
            aggr: "sum"
          },
          {
            name: "cr_local_amount",
            alias: "cr_local_amount_SUM_",
            aggr: "sum"
          },
          {
            name: "description_order",
            alias: "description_order_SUM_",
            aggr: "sum"
          },
          {
            name: "end_amount",
            alias: "end_amount_SUM_",
            aggr: "sum"
          },
          {
            name: "end_local_amount",
            alias: "end_local_amount_SUM_",
            aggr: "sum"
          },
          {
            name: "basecurrency",
            alias: "basecurrency_DISCOUNT_",
            aggr: "count_distinct"
          }
        ],
        conditions: [
