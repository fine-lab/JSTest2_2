...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let func1 = extrequire("GT65292AT10.backDefaultGroup.getGatewayAddress");
    let res = func1.execute({});
    var auth_url = res.tokenUrl;
    var api_url = res.gatewayUrl;
    ...
    function getToken(yourappkey, yourappsecrect) {
      ...
      var access_token;
      // 获取token的url
      const token_url = auth_url + "/open-auth/selfAppAuth/getAccessToken";
    ...
    return { access_token: access_token, api_url: api_url };
  }
}
