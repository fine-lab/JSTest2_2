    ...
    try {
      if (request.type == 1) {
        ...
        if (request.pk_dept != "" && request.pk_dept != null) {
          sql1 = "select code,id,name from bd.customerdoc_LKFK09.LKFK09 where id = '" + request.pk_dept + "' and dr=0";
        ...
        if (request.def9 != "" && request.def9 != null) {
          sql1 = "select code,id,name from	bd.customerdoc_LKFK07.LKFK07 where id = '" + request.def9 + "' and dr=0";
          // 研发项目
        ...
        if (request.cash_item != "" && request.cash_item != null) {
          sql1 = "select code,id,name from bd.customerdoc_LKFK31.LKFK31 where id = '" + request.cash_item + "' and dr=0";
          // 现金流量项目
          cash_item = ObjectStore.queryByYonQL(sql1, "customerdoc");
        }
        if (request.zyx24 != "" && request.zyx24 != null) {
          sql1 = "select code,id,name from bd.customerdoc_LKFK09.LKFK09 where id = '" + request.zyx24 + "' and dr=0";
          zyx24 = ObjectStore.queryByYonQL(sql1, "customerdoc");
        }
        if (request.zyx28 != "" && request.zyx28 != null) {
          sql1 = "select code,id,name from	bd.customerdoc_LKFK08.LKFK08 where id = '" + request.zyx28 + "' and dr=0";
          // 在建工程
          zyx28 = ObjectStore.queryByYonQL(sql1, "customerdoc");
        }
        if (request.zyx29 != "" && request.zyx29 != null) {
          sql1 = "select code,id,name from bd.customerdoc_LKFK29.LKFK29 where id = '" + request.zyx29 + "' and dr=0";
          // 资金来源
