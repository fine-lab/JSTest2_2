cb.defineInner([], function () {
  var MyExternal = {
    watermark(settings) {
      console.log("=============================");
      console.log(settings.oTemp);
      var oTemp = settings.oTemp;
      //默认设置
      var defaultSettings = {
      ...
      if (
        ...
        parseInt(defaultSettings.watermark_y + defaultSettings.watermark_height * defaultSettings.watermark_rows + defaultSettings.watermark_y_space * (defaultSettings.watermark_rows - 1)) >
          page_height
      ) {
