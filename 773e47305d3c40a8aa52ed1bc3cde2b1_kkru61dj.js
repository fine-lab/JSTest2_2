            ...
            function (err, res) {
              if (typeof res != "undefined") {
                ...
                if (sqwtsRes.length > 0) {
                  ...
                  licenseFwGridModelInfo.setCellValue(i, "item397ad", sqwtsRes[0].effectiveDate);
                  licenseFwGridModelInfo.setCellValue(i, "item683hi", sqwtsRes[0].validUntil);
                  licenseFwGridModelInfo.setCellValue(i, "item821bj", sqwtsRes[0].idCard);
