...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    var sql =
      "select  code, group_concat(  b.operator ) as operator   from  arap.oar.OarMain  inner join  arap.oar.OarDetail b  on b.mainid = id  where  tradetype = '1602907650714501262'   " +
      " and customer = '1630959928973721646' and localbalance != 0 and accentity = '1624180950145433604'     group  by  code ,b.operator     ";
