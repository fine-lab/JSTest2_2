...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var restemp = [];
    var yingshouSql =
      "select  customer , sum(localbalance) localbalance  from  arap.oar.OarMain where  localbalance != 0 and tradetype = '1602907650714501262' and  customer != '1633822224027746335' ";
    if (orgid != null && orgid != "") {
