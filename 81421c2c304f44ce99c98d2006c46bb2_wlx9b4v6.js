...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    var tyfksql = "select sum(jifen) from GT57020AT46.GT57020AT46.QTFK where gongsimingchen='" + qykid + "' and code<>'" + param.data[0].code + "'   "; //  晴天通用合同付款
    ...
    if (param.data[0].jifen != undefined && param.data[0].jifen != "") {
      tyfkbcxh = tyfkbcxh + Number(param.data[0].jifen); //积分消耗总数(通用合同收款)
    }
