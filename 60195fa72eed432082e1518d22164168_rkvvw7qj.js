...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    var orderDetails = data.st_othoutrecordlist;
    //声明一个数组，存放后台的字段
    var datalos;
    var temp = new Array();
        ...
        if (totalsummary.length > 0) {
          ...
          for (var i = 0; i < b; i++) {
            if (totalsummary[i] == dataod.headDefine.define3_name) {
              ...
              materialClassifySumJSON.commodity = dataod.othOutRecords_product;
              materialClassifySumJSON.commodity_name = dataod.othOutRecords_product_cName;
              ...
              //总数量也要变
              titleArray[i].total_num = titleArray[i].total_num + dataod.subQty / 1000;
