...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    const secrectdata = "appKey" + "0be9c4f56a0e46e1b29f9b140054108f" + "timestamp" + timestamp;
    var sha256 = CryptoJS.HmacSHA256(secrectdata, "04f01e5c16a346079da095ee346e98d1");
