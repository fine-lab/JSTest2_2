...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var description = "服务工单" + "-" + data.qiyemingchen_gongsimingchen + "-" + data.hetonghao;
    ...
    //付款
    var jsonbs = [];
    var shifuyoufeiyong = data.shifuyoufeiyong;
    var feiyongleixing = data.feiyongleixing;
    if (shifuyoufeiyong === "1" && feiyongleixing === "2") {
      //借方
    ...
    if (queryCode1ct !== "200") {
      ...
      var object = { id: id, new29: period, pingzhenghao: vouchercode };
      var retobj = ObjectStore.updateById("GT57529AT55.GT57529AT55.FWSP", object);
    }
