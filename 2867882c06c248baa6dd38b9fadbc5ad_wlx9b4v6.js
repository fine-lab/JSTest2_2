...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var description = "金建收款" + "-" + data.code + "-" + data.qiyeku_name + "-" + data.hetonghao;
    var hetongleixing_name = data.hetongleixing_name;
    var type = 0;
    //判断合同类型
    if (hetongleixing_name === "金建继续教育合同") {
      description = "继续教育收款" + "-" + data.code + "-" + data.qiyeku_name + "-" + data.hetonghao;
      valueCode = "007";
      type = 1;
    } else if (hetongleixing_name === "金建职称合同") {
      description = "职称收款" + "-" + data.code + "-" + data.qiyeku_name + "-" + data.hetonghao;
      valueCode = "010";
      type = 1;
    } else if (hetongleixing_name === "金建考培取证合同") {
      description = "考培取证收款" + "-" + data.code + "-" + data.qiyeku_name + "-" + data.hetonghao;
      valueCode = "008";
      type = 1;
    } else if (hetongleixing_name === "金建体系合同") {
      description = "体系收款" + "-" + data.code + "-" + data.qiyeku_name + "-" + data.hetonghao;
      valueCode = "011";
      type = 1;
    } else if (hetongleixing_name === "金建学历及网课合同") {
      description = "学历及网课收款" + "-" + data.code + "-" + data.qiyeku_name + "-" + data.hetonghao;
      valueCode = "009";
      type = 1;
    } else if (hetongleixing_name === "出证合同") {
      description = "出证合同收款" + "-" + data.code + "-" + data.hetonghao;
      valueCode = "015";
      type = 1;
    } else if (hetongleixing_name === "收证合同") {
      description = "收证合同收款" + "-" + data.code + "-" + data.hetonghao;
      valueCode = "014";
      type = 1;
    }
    //查询凭证是否存在  存在则不能再次生成
    ...
    var bodyhead = {
      ...
      voucherTypeCode: "1",
      attachedBill: "0",
      makeTime: data.shoukuanshijianKP,
      makerMobile: billid
    };
    ...
    if (qiyeku_name !== undefined) {
      ...
      if (jiesuanfangshi === "1") {
        ...
        var jsonbcredit = {
          ...
          clientAuxiliaryList: [
            {
              filedCode: "011",
              valueCode: data.shoukuanzhanghubianmakp
            }
          ]
        };
        jsonbs.push(jsonbcredit);
      ...
      if (data.ziduan22 !== undefined) {
        //贷方税金
        var creditmoney1 = data.ziduan22; //贷方金额
        var jsonbdebit1 = {
          //摘要
          description: description,
          //会计科目
        ...
        //贷方主营业务收入
        var creditmoney2 = data.shoukuanheji - data.ziduan22; //贷方金额
        var jsonbdebit2 = {
          //摘要
          description: description,
          //会计科目主营业务收入
      ...
      if (data.ziduan22 === undefined) {
        //贷方
        var creditmoney = data.shoukuanheji; //贷方金额
        var jsonbdebit = {
          //摘要
          description: description,
          //会计科目
    ...
    if (queryCode1ct !== "200") {
      ...
      var retobj = ObjectStore.updateById("GT56492AT34.GT56492AT34.JJshoukuan", object);
    }
