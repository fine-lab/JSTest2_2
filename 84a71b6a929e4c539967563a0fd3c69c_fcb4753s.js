...
class MyAPIHandler extends AbstractAPIHandler {
  execute(require) {
    var id = JSON.parse(AppContext()).currentUser.id;
    var key = "yourkeyHere";
    var appkey = "yourkeyHere";
    var access_token = getToken(appkey, key);
    var PersonURL = "https://www.example.com/" + access_token;
    var PersonParam = { userIds: [id] };
    var PersonMsg = postman("POST", PersonURL, null, JSON.stringify(PersonParam));
    var urp = postman(
      "POST",
      "https://www.example.com/",
      null,
      '{	"index":"1",	"size":"10",	"sortType":"userName",	"searchcode":"17694805033"}'
    );
    return { access_token: access_token, id: AppContext(), PersonMsg: PersonMsg, urp: urp };
