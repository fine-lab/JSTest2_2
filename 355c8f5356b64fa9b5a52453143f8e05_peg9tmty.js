...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    // 注册人/备案人名称
    var object = { id: masterId, _status: "Update", IssueDetailsList: [{ id: sonId, ProductionEnterprisName: enterprise_name, storageCondition: transportation_conditions, _status: "Update" }] };
